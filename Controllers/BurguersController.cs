...
namespace JT_webBurguer2.Controllers
{
    public class BurguersController : Controller
    {
        ...
        public BurguersController(JT_webBurguer2Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("BurguerId,BurguerName,withCheese,price,priceCeiling")] Burguer burguer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BurguerId,BurguerName,withCheese,price,priceCeiling")] Burguer burguer)
        {
